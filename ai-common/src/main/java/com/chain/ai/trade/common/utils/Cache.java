...
public interface Cache<T> {
     ...
     * @return 数据
     */
    Set<ZSetOperations.TypedTuple<Object>> zRangeByScore(String key, long from, long to);
     ...
     * @return 删除数量
     */
    Long zRemoveRangeByScore(String key, long from, long to);
    ...
    /**
     * 移除 Zset 按排名区间（ZREMRANGEBYRANK）
     *
     * @param key   key值
     * @param start 开始排名（0-based）
     * @param end   结束排名
     * @return 删除数量
     */
